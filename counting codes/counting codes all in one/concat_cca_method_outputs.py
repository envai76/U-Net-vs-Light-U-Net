...
# Example usage
csv_files = ['./synth_dataset_results/Connected_Comp_Light_U_Net.csv' , 'synth_dataset_results/Connected_Comp_U_Net.csv' ,'synth_dataset_results/Connected_Compr_Light_U_Net.csv' ,  'synth_dataset_results/Connected_Compr_U_Net.csv'     ]
output_file = "./synth_dataset_results/concat_cca_synth.csv"
